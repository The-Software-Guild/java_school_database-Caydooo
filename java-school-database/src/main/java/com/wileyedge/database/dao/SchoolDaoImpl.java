    ...
    * Do not change any code outside of the placeholders provided.
    ...
    public List<Course> csCourses() {
        ...
        // YOUR CODE STARTS HERE
         ...
         String sql = "SELECT course.courseCode, course.courseDesc FROM\n"
        		 + " course JOIN teacher ON course.teacherId=teacher.tid\n"
    ...
    public List<StudentClassCount> studentsPerClass() {
        ...
        String sql = "SELECT course.courseCode, course.courseDesc, COUNT(course_student.student_id)\n"
        		+ " AS `numStudents` FROM course JOIN course_student ON\n"
        		+ " course.cid=course_student.course_id GROUP BY course_student.student_id;";
    ...
    public void addStudentToClass() {
        ...
        String sql = "INSERT INTO course_student (student_id, course_id)\n"
        		+ " SELECT student.sid, course.cid FROM student, course WHERE student.fName='Robert'\n"
        		+ " AND student.lName='Dylan' AND course.courseCode='CS148';";
